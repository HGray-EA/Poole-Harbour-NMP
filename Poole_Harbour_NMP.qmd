...
![](/dbfs/FileStore/WSX_HGray/Piddle_Tot_N_timeseries.png)!\[Piddle N Total Timeseries\]\]("/dbfs/FileStore/WSX_HGray/Piddle_Tot_N\_timeseries.png")

![](/dbfs/FileStore/WSX_HGray/Piddle_N_Tot_mean_normalised_conc.png)
...
Sher_N <- ggplot(Sher.N.wq.data, aes(Date, Result)) +
 ...
 scale_y_continuous(limits = c(2.5, 10)) +
  scale_color_gradient2(colors = met.brewer("Derain", direction = -1)) +
  geom_smooth(method = "gam", formula = y ~ s(x, bs = "cs"), colour = "red") +
