...
[![SAGIS Baseline 2024 Outputs](/dbfs/FileStore/WSX_HGray/SAGIS_Baseline_2024.png)](https://eaimportalpoc.esriuk.com/portal/apps/webappviewer/index.html?id=ba893996b8424dda9020194e1d9bebde%20Timeseries%20trends)

![SAGIS Amp9 2024 Outputs](/dbfs/FileStore/WSX_HGray/SAGIS_Amp9_2024.png)

### Feshwater Nitrogen & Phosphate Trends

Below the nutrients are mapped for the four main feeder rivers to the Harbour, the river Frome exports the most drains an area \~3 times that of the Piddle In the Frome at Holme Bridge we see a decrease in Orthophosphate since 2000 whilst Nitrogen Total flat lines.
...
![](/dbfs/FileStore/WSX_HGray/Piddle_Tot_N_timeseries.png) ![](/dbfs/FileStore/WSX_HGray/Piddle_N_Tot_mean_normalised_conc.png)

![](/dbfs/FileStore/WSX_HGray/Piddle_total_p_conc_over_time.png)
...
In the Piddle we see the same story since 2000 as the Frome, although Orthophosphate has only since the last 5 years met the levels of reduced Orthophosphate as the Frome.
...
The Corfe D/S Corfe STW tells the same story as the river Sherford, with a decrease in both Orthophosphate and Total Nitrogen since 2000. Unlike other rivers which feed Poole Harbour, Corfe river continues to show this decrease, albeit modest from 2015-2025. It records the lowest levels of Orthophosphate of tributaries to Poole Harbour, but is the smallest tributary by drainage volume.
